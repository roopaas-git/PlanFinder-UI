...
export class ComparePlansservice {
    ...
    getAllBenefitGroups(): Observable<IAllBenefitGroup[]> {    
        return this.http.get<IAllBenefitGroup[]>(`${this.config.apiEndpoint}ComparePlans/GetAllBenefitGroups/`).pipe(map((data: any) => {            
            return data.result
        }))
    }
